...
export default function DeleteEquipmentMachineConfirmationModal({
  deleteButtonLoading,
  deleteEquipmentMachine,
  selectedDeleteMachineUID,
  onClose,
  isOpen,
}) {
      ...
      >
        ...
        <ModalContent bg={"white"} minW={"500px"}>
          <ModalHeader
            ...
            color={"#dc143c"}
          >
            Delete Equipment/Machine from worksite?
          </ModalHeader>
          ...
          <ModalBody>
            <Flex flexDir={"column"}>
              <Flex fontWeight={700}>
                Are you sure you want to delete this Equipment/Machine?
              </Flex>
              <Flex fontSize={"14px"} color={"#848484"}>
                deleting this equipment/machine is permanent and cannot be
                undone.
              </Flex>
            </Flex>
          </ModalBody>
