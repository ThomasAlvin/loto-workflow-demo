...
export default function DeleteLockConfirmationModal({
  deleteButtonLoading,
  deleteLock,
  selectedDeleteLockUID,
  onClose,
  isOpen,
}) {
        ...
        <ModalContent bg={"white"} minW={"500px"}>
          ...
          <ModalBody>
            <Flex flexDir={"column"}>
              ...
              <Flex fontSize={"14px"} color={"#848484"}>
                deleting this lock is permanent and cannot be undone.
              </Flex>
            </Flex>
          </ModalBody>
          <Divider m={0} />
          <ModalFooter gap={"10px"} w={"100%"} justifyContent={"end"}>
            ...
            <Button
              ...
              color={"white"}
              onClick={() => {
                deleteLock(selectedDeleteLockUID);
              }}
            >
              Confirm
            </Button>
