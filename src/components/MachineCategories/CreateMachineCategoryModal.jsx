...
export default function CreateMachineCategoryModal({
      ...
      {layout == "card" ? (
        ...
        >
          ...
          <Flex flexDir={"column"} alignItems={"center"}>
            ...
            <Flex fontSize={"12px"} color={"#848484"} textAlign={"center"}>
              Still not enough? click here to add a new machine category
            </Flex>
          </Flex>
        </Flex>
      ) : (
        <MenuItem onClick={onOpen}>
          <Flex alignItems={"center"} gap={"10px"}>
            ...
            <Flex>Add Machine Category manually</Flex>
          </Flex>
        </MenuItem>
      )}
      <Modal
      ...
      >
        ...
        <ModalContent bg={"white"} maxW="60%" maxH={"90vh"} overflow={"auto"}>
          <ModalHeader
            ...
            flexDir={"column"}
          >
            <Flex color={"crimson"}>Create Machine Category </Flex>
