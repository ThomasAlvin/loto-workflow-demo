...
export default function DeleteWorkOrderConfirmationModal({
  deleteButtonLoading,
  deleteWorkOrder,
  selectedDeleteWorkOrderUID,
  onClose,
  isOpen,
}) {
      ...
      >
        ...
        <ModalContent bg={"white"} minW={"500px"}>
          <ModalHeader
            ...
            color={"#dc143c"}
          >
            Delete Work order from worksite?
          </ModalHeader>
          ...
          <ModalBody>
            <Flex flexDir={"column"}>
              ...
              <Flex fontSize={"14px"} color={"#848484"}>
                deleting this Work order is permanent and cannot be undone.
              </Flex>
            </Flex>
          </ModalBody>
          <Divider m={0} />
          <ModalFooter gap={"10px"} w={"100%"} justifyContent={"end"}>
            ...
            <Button
              ...
              color={"white"}
              onClick={() => {
                deleteWorkOrder(selectedDeleteWorkOrderUID);
              }}
            >
              Confirm
            </Button>
