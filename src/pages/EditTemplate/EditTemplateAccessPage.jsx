...
export default function EditTemplateAccessPage({
  ...
  const disableEditTemplateAccess = templateDetails?.access?.some(
    (member) =>
      member.role === "authorized_user" && member.email === userSelector.email
  );
                              ...
                              {val.role === "owner" ? (
                                ...
                                <>
                                  ...
                                  >
                                    <Flex justifyContent={"center"}>
                                      <Checkbox
                                        isDisabled={disableEditTemplateAccess}
                                        id="edit"
